...
import type { BoardJob, JobHistoryEntry, JobHistoryPhase } from "../dashboard.types";
...
export function JobHistory({ job, onClose, embedded }: JobHistoryProps) {
  ...
  const timeline = (
    <>
      ...
      {data && data.length === 0 && (
        <p className="text-sm text-gray-500">No tracking events recorded for this job yet.</p>
      )}
